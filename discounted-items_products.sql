...
CREATE TABLE `products` (
  ...
  `UnitsOnOrder` bigint DEFAULT NULL,
  `ReorderLevel` bigint DEFAULT NULL,
  `Discontinued` bigint DEFAULT NULL,
  PRIMARY KEY (`ProductID`),
  UNIQUE KEY `idx_products_ProductID` (`ProductID`),
